window.domReady(function() {
    ...
    var scrollItems = document.querySelectorAll('.section-header, .projects-list, .skills-list, .clients-list, .cc-contact p, .hellomynameiskevin img, .about-content p, .social-networks li, .contact-avatar img, .footer q, .footer cite'),
